                ...
                <div className="grid grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    <p className="text-sm text-gray-500">
                      "Tea, though ridiculed by those who are naturally coarse in their nervous sensibilities, will lways be the favorite beverage of the intellectual."-Thomas De Quincey
                    </p>
                  </div>
                </div>
              </div>
